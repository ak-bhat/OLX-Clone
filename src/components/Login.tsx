          ...
          <div className="sm:flex sm:items-start">
            <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
              <div className="mt-2">
                ...
                <p className="text-base font-medium mt-5">Help us to become one of the safest place to buy and sell</p>
                ...
                <div className="flex border border-gray-300 p-2 rounded-md mt-4">
                    ...
                    <h1 className="font-semibold ml-3">Continue with Google</h1>
                </div>
              </div>
            </div>
          </div>
