          ...
          <div className="sm:flex sm:items-start">
            <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
              <div className="mt-2">
                ...
                <p className="text-base font-medium mt-5 text-center">Help us to become one of the safest place <br/>to buy and sell</p>
                ...
                <h1 className="text-center mt-4 text-xs text-blue-500">Terms and Conditions</h1>
              </div>
            </div>
          </div>
        </div>
